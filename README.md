...
| [codepipeline-docker-build](https://github.com/aws-samples/aws-cdk-examples/tree/master/python/codepipeline-docker-build/) | Shows how to create a docker build using Code Pipeline |
